...
3.  **Перед началом любой работы ты обязана полностью прочитать и проанализировать следующие файлы проекта, чтобы понимать его контекст:**
    ...
    *   `C:\Users\user\IdeaProjects\SpringFramework\website-search-engine\build.gradle`
    *   `C:\Users\user\IdeaProjects\SpringFramework\website-search-engine\src\main\resources\schema.sql`
    *   `C:\Users\user\IdeaProjects\SpringFramework\website-search-engine\src\main\resources\logback.xml`
